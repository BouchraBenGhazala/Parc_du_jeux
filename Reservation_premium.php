...
?>
        ...
        <div class="row flex-column flex-sm-row">
            <div class="col-sm-6">
                ...
                <div class="row">
                    <h4 id="content" class="text-center ">Billet Premium</h4>
                </div>
                <br>
                <div class="row flex-column flex-sm-row">
                    <div class="col-sm-6">
                ...
                <div class="row flex-column flex-sm-row">
                    <div class="col-sm-6">
                    <p><span id="gras">Adulte </span><?php echo  $prix_adulte_premium?> <br>12 ans et plus<p>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row flex-column flex-sm-row">
                    <div class="col-sm-6">
                    <p><span id="gras">Enfant </span> <?php echo $prix_enfant_premium?> <br>3 à 11 ans<p>
                    </div>
                    <div class="col-sm-6">
